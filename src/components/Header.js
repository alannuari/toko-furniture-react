            ...
            <div className="container mx-auto py-5">
                <div className="flex flex-stretch items-center">
                    ...
                    <div className="w-auto">
                        <ul
                            className={[
                                'fixed bg-white text-black inset-0 flex flex-col items-center justify-center md:visible md:flex-row md:bg-transparent md:relative md:opacity-100 md:flex md:items-center',
                                toggleMenu ? 'opacity-100 z-30 visible' : 'invisible opacity-0',
                            ].join(' ')}
                            id="menu"
                        >
                            <li className="mx-3 py-6 md:py-0">
                                <Link to="/showcase" className={['hover:underline text-black', theme === 'white' ? 'md:text-black' : ''].join(' ')}>
                                    Showcase
                                </Link>
                            </li>
                            <li className="mx-3 py-6 md:py-0">
                                <Link to="/catalog" className={['hover:underline text-black', theme === 'white' ? 'md:text-black' : ''].join(' ')}>
                                    Catalog
                                </Link>
                            </li>
                            <li className="mx-3 py-6 md:py-0">
                                <Link to="/delivery" className={['hover:underline text-black', theme === 'white' ? 'md:text-black' : ''].join(' ')}>
                                    Delivery
                                </Link>
                            </li>
                            <li className="mx-3 py-6 md:py-0">
                                <Link to="/rewards" className={['hover:underline text-black', theme === 'white' ? 'md:text-black' : ''].join(' ')}>
                                    Rewards
                                </Link>
                            </li>
                        </ul>
                    ...
                    <div className="w-auto">
                        <ul className="items-center flex">
                            ...
                            <li className="ml-6">
                                <Link
                                    id="header-cart"
                                    className={['cart flex items-center text-black justify-center w-8 h-8', state.cart && Object.keys(state.cart).length > 0 ? 'cart-filled' : '', isCartChanged ? 'animate-bounce' : ''].join(' ')}
                                    to="/cart"
                                >
                                    <IconCart />
                                </Link>
